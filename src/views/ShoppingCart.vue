        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="row">
              ...
              <!-- penggunaan V-model untuk inputan dari data API -->
              <div class="col-lg-8">
...
// ketika ingin menggunakan sebuah API harus pake package Axios
...
export default {
  ...
  // metode seperti ini kita akan jalankan ketika ada fungsi onclick, hover,event
  methods: {
    removeItem(index) {
      this.keranjangUser.splice(index, 1);
      const parsed = JSON.stringify(this.keranjangUser);
      localStorage.getItem("keranjangUser", parsed);
    },
    // fungsi mengirimdata ke API
    checkout() {
      // buat sebuah variabel dengan nama let productIds , knp pake map karena product tsb jumlah nya bnyk
      // variabel ini akan jadikan nilai array
